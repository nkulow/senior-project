...
<body>
		...
		<div class="row">
			<div class="col-md-4">
				<figure class="card card-product">
					<div class="img-wrap"><img src="images/bigigloocooler.jpg"></div>
					<figcaption class="info-wrap">
						<!-- Select statement for ProductName -->
						<h4 class="title">
							<?php 
						...
						<?php
							...
							$sql = "SELECT Description FROM Products WHERE ProductID = 1";
							$stmt = sqlsrv_query($conn, $sql);
							if($stmt === false){
								die(print_r(sqlsrv_errors(), true));
							}
					...
					<div class="bottom-wrap">
						<form style="float: right;" onclick="myFunction()" target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="hosted_button_id" value="W4QT73V3NDSHJ">
						...
						<div class="price-wrap h5">
							<span class="price-new">$
								<?php
									...
									$sql = "SELECT CAST(Price as decimal(10,2)) FROM Products WHERE ProductID = 1";
									$stmt = sqlsrv_query($conn, $sql);
									if($stmt === false){
										die(print_r(sqlsrv_errors(), true));
									}
			...
			<div class="col-md-4">
				<figure class="card card-product">
					<div class="img-wrap"><img src="images/carryallbag.jpg"> </div>
					<figcaption class="info-wrap">
						<h4 class="title">
							<?php 
						...
						<?php
							...
							$sql = "SELECT Description FROM Products WHERE ProductID = 2";
							$stmt = sqlsrv_query($conn, $sql);
							if($stmt === false){
								die(print_r(sqlsrv_errors(), true));
							}
					...
					<div class="bottom-wrap">
						<form style="float: right;" onclick="myFunction()" target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
							<input type="hidden" name="cmd" value="_s-xclick">
							<input type="hidden" name="hosted_button_id" value="CB8U7Q39D6EPE">
							<input type="submit" value="Add to Cart" class="btn btn-sm btn-primary float-right" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
							<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
						</form>		
						<div class="price-wrap h5">
							<span class="price-new">$
								<?php
									...
									$sql = "SELECT CAST(Price as decimal(10,2)) FROM Products WHERE ProductID = 2";
									$stmt = sqlsrv_query($conn, $sql);
									if($stmt === false){
										die(print_r(sqlsrv_errors(), true));
									}
			...
			<div class="col-md-4">
				<figure class="card card-product">
					<div class="img-wrap"><img src="images/rogueprosleepingbag.jpg"></div>
					<figcaption class="info-wrap">
						<!-- select statement for product name-->
						<h4 class="title">
							<?php 
					...
					<div class="bottom-wrap">
						<form style="float: right;" onclick="myFunction()" target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
							<input type="hidden" name="cmd" value="_s-xclick">
							<input type="hidden" name="hosted_button_id" value="AZ4FFPYNLCHBY">
							<input type="submit" value="Add to Cart" class="btn btn-sm btn-primary float-right" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
							<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
						</form>		
						<div class="price-wrap h5">
							<span class="price-new">$
								<?php
									...
									$sql = "SELECT CAST(Price as decimal(10,2)) FROM Products WHERE ProductID = 3";
									$stmt = sqlsrv_query($conn, $sql);
									if($stmt === false){
										die(print_r(sqlsrv_errors(), true));
									}
	...
	<div> <!-- product cards with 3 in each row -->
		<div class="row">
			<div class="col-md-4">
				<figure class="card card-product">
					<div class="img-wrap"><img src="images/mummysleepingbag.jpg"></div>
					<figcaption class="info-wrap">
						<!-- select statement for product name-->
						<h4 class="title">
							<?php 
						...
						<?php
							...
							$sql = "SELECT Description FROM Products WHERE ProductID = 4";
							$stmt = sqlsrv_query($conn, $sql);
							if($stmt === false){
								die(print_r(sqlsrv_errors(), true));
							}
					...
					<div class="bottom-wrap">
						<form style="float: right;" onclick="myFunction()" target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
							<input type="hidden" name="cmd" value="_s-xclick">
							<input type="hidden" name="hosted_button_id" value="VJ844NSZF96UA">
							<input type="submit" value="Add to Cart" class="btn btn-sm btn-primary float-right" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
							<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
						</form>		
						<div class="price-wrap h5">
							<span class="price-new">$
								<?php
									...
									$sql = "SELECT CAST(Price as decimal(10,2)) FROM Products WHERE ProductID = 4";
									$stmt = sqlsrv_query($conn, $sql);
									if($stmt === false){
										die(print_r(sqlsrv_errors(), true));
									}
			...
			<div class="col-md-4">
				<figure class="card card-product">
					<div class="img-wrap"><img src="images/gerberfoldingknife.jpg"> </div>
					<figcaption class="info-wrap">
						<!-- select statement for product name-->
						<h4 class="title">
							<?php 
					...
					<div class="bottom-wrap">
						<form style="float: right;" onclick="myFunction()" target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
							<input type="hidden" name="cmd" value="_s-xclick">
							<input type="hidden" name="hosted_button_id" value="KZ76KNMSJZWRU">
							<input type="submit" value="Add to Cart" class="btn btn-sm btn-primary float-right" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
							<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
						</form>		
						<div class="price-wrap h5">
							<span class="price-new">$
								<?php
									...
									$sql = "SELECT CAST(Price as decimal(10,2)) FROM Products WHERE ProductID = 5";
									$stmt = sqlsrv_query($conn, $sql);
									if($stmt === false){
										die(print_r(sqlsrv_errors(), true));
									}
			...
			<div class="col-md-4">
				<figure class="card card-product">
					<div class="img-wrap"><img src="images/lifestraw.jpg"></div>
					<figcaption class="info-wrap">
						<!-- select statement for product name-->
						<h4 class="title">
							<?php 
								
								$sql = "SELECT ProductName FROM Products WHERE ProductID = 6";
								$stmt = sqlsrv_query($conn, $sql);
								if($stmt === false){
									die(print_r(sqlsrv_errors(), true));
								}
						...
						<?php
							...
							$sql = "SELECT Description FROM Products WHERE ProductID = 6";
							$stmt = sqlsrv_query($conn, $sql);
							if($stmt === false){
								die(print_r(sqlsrv_errors(), true));
							}
					...
					<div class="bottom-wrap">
						<form style="float: right;" onclick="myFunction()" target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
							<input type="hidden" name="cmd" value="_s-xclick">
							<input type="hidden" name="hosted_button_id" value="E598H5NEFKWXY">
							<input type="submit" value="Add to Cart" class="btn btn-sm btn-primary float-right" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
							<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
						</form>		
						<div class="price-wrap h5">
